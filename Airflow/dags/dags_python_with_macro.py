...
with DAG(
    dag_id="dags_python_with_macro_eg", # 파일명과 통일
    schedule="0 0 * * *", # 매월 말일
    ...
    def get_datetime_calc(**kwargs):
        ...
        print('start_date: '+prev_month_day_first.strftime('%Y-%m-%d'))
        print('end_date: '+prev_month_day_last.strftime('%Y-%m-%d'))
